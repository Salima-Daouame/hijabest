...
import LogoM1 from '../../public/img/Muslim01.png';
...
function NavbarDesk() {
  ...
  return (
    < div >
      <header className="bg-indigo-700 bg-opacity-5 text-black shadow-lg hidden md:block dark:text-white dark:bg-slate-900" >
        <div className="container mx-auto flex items-center h-23">
          {theme === 'dark' ?
            (<img className="h-20" src={LogoM1} alt="" />)
            :
            (<img className="h-20" src={LogoM} alt="" />)}
          <BrowserRouter>
            <nav className="contents font-semibold text-base lg:text-lg font-mono">
              <ul className="mx-auto flex items-center">
                <li className='p-3 hover:text-slate-700  rounded-xl m-2 cursor-pointer duration-300 hover:text-black'>
